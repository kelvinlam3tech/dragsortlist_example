...
import com.example.dragsortlistview.R;
...
public class DragSortListView extends ListView {
     ...
     * move the check state from the item's old position to the new position þýþý     * which is all fine and good (and removes the need for calling this
